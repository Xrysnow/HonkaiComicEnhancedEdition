...
const BgmGlobalInfo = {
    1: ['Unknown', 'Yesterday', -9.86],
    2: ['Sea Wall', 'Alive', -7.43],
    3: ['A.O.S forces', '崩坏学园2', -8.97],
    4: ['Trace', 'Onwards', -14.48],
    5: ['Snowfield', 'Onwards', -9.31],
    6: ['Narrate', 'Alive', -5.78],
    7: ['Another', 'Impact', -15.47],
    8: ['Lose', 'Alive', -1.39],
    9: ['Raid', 'Onwards', -14.51],
    10: ['Rage', 'Impact', -16.47],
    11: ['North Wind', 'Yesterday', -8.5],
    12: ['The World', '后崩坏书', -12.84],
    13: ['Del', 'Alive', -11.49],
    14: ['Pendant', 'Yesterday', -7.69],
    15: ['未定的注定 (伴奏)', '未定的注定', -11.63],
    16: ['A Sprinkling of Warmth', '女武神的餐桌', 0/* 8.25 */],
    17: ['未来再见 (Instrumental)', '女武神的餐桌2', -12.3],
    18: ['Firew', 'Alive', -7.8],
    19: ['Kevin', 'Yesterday', -14.55],
    20: ['Freez', 'Alive', -11.5],
    ...
    27: ['真红之剑', 'Review', -14.18],
    28: ['Oracle (伴奏)', 'Oracle', -12.11],
    29: ['向天举起叛逆之剑', 'Review', -14.47],
    30: ['Clouds', 'Onwards', -12.89],
    31: ['Kong', 'Yesterday', 0],
    32: ['Rubia (伴奏)', 'Rubia', 0],
    33: ['Musta virta', '崩坏学园2', 0],
    34: ['Lighting', 'Impact', 0],
    35: ['Ark', 'Impact', 0],
    36: ['DATE-IV', '崩坏学园2', 0],
    37: ['Race Is On', 'Yesterday', 0],
    38: ['Enough', 'Yesterday', 0],
    39: ['Yesterday', 'Yesterday', 0],
    40: ['Never Let You Go', 'Yesterday', 0],
    41: ['Why', 'Yesterday', 0],
    42: ['Enough', 'Yesterday', 0],
    43: ['Shopsation', '崩坏学园2', 0],
    44: ['And IsL', '后崩坏书2', 0],
    45: ['Kolosten', 'Paradox', 0],
    46: ['Sabre', 'Paradox', 0],
    47: ['Otto', 'Paradox', 0],
    48: ['Constraint', 'Paradox', 0],
    49: ['IRAS 17514', 'Paradox', 0],
    50: ['Tiger', '崩坏学园2', 0],
    51: ['Beloved', 'Onwards', 0],
    52: ['Moonrise', 'Onwards', 0],
    53: ['Revir', '后崩坏书', 0],
    54: ['Es', 'Alive', 0],
    55: ['Ambiguous Light', '跨越终焉之日', 0],
    56: ['Dissipate', 'Paradox', 0],
    57: ['A-310', 'Review', 0],
    58: ['月影逐龙', 'Review', 0],
    59: ['Noitats', '后崩坏书', 0],
    60: ['Candy Room', 'Elysium', 0],
    61: ['Brief', 'Elysium', 0],
    62: ['Deep Waves', 'Yesterday', 0],
    63: ['Honkai Impact 3rd', '跨越终焉之日', 0],
    64: ['Katana', 'Onwards', 0],
    65: ['赤染御魂', 'Review', 0],
    66: ['Sink', 'Yesterday', 0],
    67: ['Routine', 'Onwards', 0],
    68: ['Elsewhere', 'Onwards', 0],
    69: ['Clock', 'Yesterday', 0],
    70: ['Ortem', '后崩坏书', 0],
    71: ['Planet Directory', '跨越终焉之日', 0],
    72: ['Paradox', 'Yesterday', 0],
    73: ['Ann', 'Alive', 0],
    74: ['Shrine', 'Onwards', 0],
    75: ['Empty', 'Onwards', 0],
    76: ['Decisive', 'Alive', 0],
    77: ['Lil\' Dash of Love', '女武神的餐桌', 0],
    78: ['Egdirb', '后崩坏书', 0],
    79: ['Haxxor Bunny', 'Paradox', 0],
    80: ['Mystify', 'Onwards', 0],
    81: ['Ele Wh', '后崩坏书2', 0],
    82: ['Vortex', 'Yesterday', 0],
    83: ['Xiao', 'Yesterday', 0],
    84: ['Wreckage', 'Paradox', 0],
    85: ['Regression (伴奏)', 'Regression', 0],
    86: ['I Alone Am Honored', 'Paradox', 0],
    87: ['Distant', 'Paradox', 0],
    88: ['Consciousness', '跨越终焉之日', 0],
    89: ['Cowboy', 'Paradox', 0],
    90: ['Tins', '跨越终焉之日', 0],
    91: ['Gion3', '跨越终焉之日', 0],
