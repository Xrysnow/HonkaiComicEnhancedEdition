(function () {
    ...
    p.editorNote = {
        zh: '- 本篇为主线漫画（原“崩坏3rd”系列漫画）的第一篇。'
            ...
            + '</br>- 官方曾推出过<a href="https://mp.weixin.qq.com/s/ZLjfY3hjZEMvnDxw8ibqKw">序章的实体版</a>作为非卖品（开本尺寸为大16开）。'
            + '</br>- 官方曾推出过<a href="https://mp.weixin.qq.com/s/ebilHIhQCGaTCuAE5tBF-A">实体版书籍</a>，已绝版。'
